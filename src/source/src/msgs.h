...
public:
	enum Id
	{
		...
		CPU_x16_Alt,
		CPU_xVDIGIT,
		Sync_Machine_Speed_With_CPU_Speed,
		Async_Machine_Speed_With_CPU_Speed,
		Checker_Drawing,
		...
		Show_message_when_boot_device_was_changed,
		Setting_of_boot_device_in_SRAM_was_changed,
		Parameters_in_SRAM_,
...
//		PIA_on_L3,
		...
		There_is_the_same_disk_in_drive_VDIGIT_and_VDIGIT,
