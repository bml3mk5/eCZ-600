...
#endif
{
	...
	msgs[i++] = _TX("800msec.");
	msgs[i++] = _TX("MIDI Out");
	msgs[i++] = _TX("MIDI Output Latency");
	msgs[i++] = _TX("Send MIDI Reset");
	msgs[i++] = _TX("Other");
	msgs[i++] = _TX("Start...");
	msgs[i++] = _TX("Devices");
	msgs[i++] = _TX("Save");
	...
	msgs[i++] = _TX("SCSI Type (*)");
	msgs[i++] = _TX("I/O Port (*)");
	msgs[i++] = _TX("Floating Point Prosessor Board (CZ-6BP1)");
	msgs[i++] = _TX("SCSI Board (CZ-6BS1)");
	msgs[i++] = _TX("SCSI (Inner Type)");
	msgs[i++] = _TX("MIDI");
	msgs[i++] = _TX("Enable MIDI Board (CZ-6BM1).(*)");
	msgs[i++] = _TX("Now Connecting MIDI Output");
	msgs[i++] = _TX("MIDI Reset Type");
	msgs[i++] = _TX("GM Sound Module");
	msgs[i++] = _TX("GS Sound Module");
	msgs[i++] = _TX("LA Sound Module");
	msgs[i++] = _TX("XG Sound Module");
	msgs[i++] = _TX("User Setting");
	msgs[i++] = _TX("When send reset message:");
	msgs[i++] = _TX("Power on");
	msgs[i++] = _TX("Power off");
	msgs[i++] = _TX("Reset by hand");
	msgs[i++] = _TX("End of app.");
	msgs[i++] = _TX("Send message now");
	msgs[i++] = _TX("Does not send system real-time messages.");
	...
	msgs[i++] = _TX("Raster Interrupt Vertical Skew");
	msgs[i++] = _TX("Raster Interrupt Horizontal Skew");
	msgs[i++] = _TX("Vertical Disp Skew");
	msgs[i++] = _TX("Horizontal Disp Skew");
	msgs[i++] = _TX("BMP");
	msgs[i++] = _TX("PNG");
	msgs[i++] = _TX("OFF");
	msgs[i++] = _TX("ON");
	...
	msgs[i++] = _TX("Show message when parameters related on start-up was changed.");
	msgs[i++] = _TX("The setting of boot device in SRAM was changed.");
	msgs[i++] = _TX("The start address in SRAM was changed,");
	...
	msgs[i++] = _TX("Accumulated operating time");
	msgs[i++] = _TX("Times of turned off");
	msgs[i++] = _TX("min.");
	...
	msgs[i++] = _TX("Hiragana");
	msgs[i++] = _TX("Zenkaku");
	msgs[i++] = _TX("Parameters for floppy disk in SRAM");
	msgs[i++] = _TX("Parameters for hard disk in SRAM");
	msgs[i++] = _TX("Number of SASI HDDs");
	msgs[i++] = _TX("SCSI enable flag");
	msgs[i++] = _TX("SCSI host ID");
	msgs[i++] = _TX("SASI HDDs on SCSI");
	...
	msgs[i++] = _TX("Open SASI Disk %d");
	msgs[i++] = _TX("Open SASI Disk %d unit %d");
	msgs[i++] = _TX("Open SCSI Disk %d");
	msgs[i++] = _TX("New Hard Disk %d");
	msgs[i++] = _TX("New SASI Disk %d");
	msgs[i++] = _TX("New SASI Disk %d unit %d");
	msgs[i++] = _TX("New SCSI Disk %d");
	msgs[i++] = _TX("Device Type");
	msgs[i++] = _TX("Select Device Type");
	msgs[i++] = _TX("Select a device type on SASI disk %d.");
	msgs[i++] = _TX("Select a device type on SCSI disk %d.");
	msgs[i++] = _TX("Mount [");
	msgs[i++] = _TX("Mount...");
	msgs[i++] = _TX("Unmount");
	msgs[i++] = _TX("SASI%d");
	msgs[i++] = _TX("SASI%d u%d");
	msgs[i++] = _TX("SCSI%d");
...
//	msgs[i++] = _TX("PIA on L3");
	...
	msgs[i++] = _TX("Disk image on SASI%d unit %d couldn't be opened.");
	msgs[i++] = _TX("Disk image on SCSI%d couldn't be opened.");
	msgs[i++] = _TX("There is the same hard disk in %s and %s.");
